...
$(document).ready(function () {
	...
	var $questionSet =  [{answer: '6', 
						...
						{answer: '178', 
						 ...
						 f: 'Понимаем, тут легко запутаться, но мы в тебя верим, попробуй ещё'},
						 {answer: '12,28', 
						 t: 'Верно! 12-летний и 28- летний юбилеи совместной жизни у супругов называются Никелевой свадьбой.' ,
						 f: 'Математика - это не твоё, да?'},
						 {answer: '0,6', 
						 t: 'Верно! Именно 0,6% составляет доля Норникеля в ВВП страны' ,
						 f: 'Математика - это не твоё, да?'},
						 {answer: '10', 
						 t: 'Да, это было легко Норильск никогда не спит! Предприятия компании работают в три смены - производство никогда не останавливается. Поэтому в городе в любое время суток есть кто-то, кто собирается на работу, и кто только что с работы пришел.' ,
						 f: 'Напоминаем, что в сутках всего 24 часа, попробуй ещё раз.'},
						 {answer: '3,8', 
						 t: 'Аргоненно верно! Выручка компании в первом полугодии 2017 составила 3,8 млрд долларов. В такую же сумму, по мнению аналитиков, к 2019 году будет оцениваться весь рынок электронной коммерции в Индонезии.' ,
