...
$(document).ready(function () {
	...
	var $questionSet =  [{answer: '6', 
						 t: 'Поздравляем, пока школьная математика тобой не забыта! \nФакт #1\n\nКоллективный договор компании признан лучшим в России. В него входит также один из самых привлекательных в отрасли социальных пакетов: бесплатный ежегодный перелет работника «Норникеля» и членов его семьи к месту отдыха и обратно, участие в корпоративных жилищных программах, корпоративные пенсионные программы, отдых по льготным ценам на лучших мировых курортах, медицинское обслуживание.\n\nНапомню, что впереди тебя ждёт ещё 8 увлекательных фактов и интересных задач! Подсказку ищи на плакате, ну а если совсем потеряешься, то обратись к организаторам форума с вопросами!\nУдачи!' ,
						 f: 'Что гуманитарий делает на форуме для технарей? Либо это просто была опечатка, попробуй ещё раз.'},
						{answer: 'норникель', 
						 t: 'Совершенно верно! Но ведь и шифр был простеньким ;)\n\nФакт #2\nВ компании работает более 80 тыс. человек, а количество профессий превышает 150! Только представь, какие масштабы!' ,
						 f: 'Всё куда проще – А=1, Б=2, В=3… смекаешь? Попробуй ещё раз.'},
						{answer: '178', 
						 t: 'Браво! У тебя есть все шансы собрать костюм железного человека!\n\nФакт #3.\n«Норникель» занимает первое место в мире (40%) по объему производства палладия. Этот металл является одним из самых перспективных на рынке драгметаллов и одним из самых востребованных у производителей электронной техники: в одном сотовом телефоне может содержаться до 9 мг палладия, а ноутбуке – до 80 мг.\n\nДальше - больше! ;)' ,
						 f: 'Увы, до Тони Старка тебе далеко! Попробуй ещё раз.'},
						 {answer: 'илон маск', 
						 t: 'Ну конечно! Кто, если не он!\n\nФакт #4.\nСоздание альтернативных источников энергии, в том числе гибридных электро-двигателей, не возможно без никеля. Этот металл, в свою очередь, является основной товарной продукции компании «Норникель», доля которого на мировом рынке составляет 12% (второе место по объёму производства).\n\nПоскорее ищи Факт #5!' ,
						 f: 'Ага... или Пушкин. Попробуй ещё раз.'},
						 {answer: '10', 
						 t: 'Превосходно!\n\nФакт #5\nВ организме человека содержится примерно 10 мг никеля. Он обеспечивает клетки кислородом, связан с метаболизмом глюкозы и оказывает благотворное влияние на организацию структуры ДНК человека!\n\nРазве не круто?' ,
						 f: 'Понимаем... Тут легко запутаться, но мы в тебя верим! Попробуй ещё раз.'},
						 {answer: '12,28', 
						 t: 'Верно! \n\nФакт #7\n12-летний и 28- летний юбилеи совместной жизни у супругов называются Никелевой свадьбой.\n\nОтправляйся на поиски 7-го факта!' ,
						 f: 'Математика - это не твоё, да?'},
						 {answer: '0,6', 
						 t: 'Верно! \n\nФакт #7\nИменно 0,6% составляет доля компании \"Норникель\" в ВВП России!' ,
						 f: 'Математика - это не твоё, да?'},
						 {answer: '10', 
						 t: 'Да, это было просто!\n\nФакт #8 \nНорильск никогда не спит! Предприятия компании работают в три смены, производство никогда не останавливается! Именно поэтому в городе в любое время суток есть кто-то, кто собирается на работу, и кто только что с работы пришел.' ,
						 f: 'Напоминаем, что в сутках всего 24 часа, попробуй ещё раз.'},
						 {answer: '3,8', 
						 t: 'Аргоненно верно! \n\nФакт #9\nВыручка компании в первом полугодии 2017 составила 3,8 млрд долларов. В такую же сумму, по мнению аналитиков, к 2019 году будет оцениваться весь рынок электронной коммерции в Индонезии.\nНадеюсь, ты хорошо запомнил все факты, ведь именно они сыграют главную роль в твоей победе на викторине от компании «Норникель»! \nВ 17:30 подходи на 1-ю сцену и участвуй! Желаем удачи и спасибо тебе за игру! ;)' ,
						 f: 'Ошибиться в химии не так страшно, как в жизни, попробуй ещё раз.'}]
	$("#id").hide();
	
	$("#checkAnswer").click(function (e) {
        e.preventDefault();
        client_answer = $("#clientAnswer").val().toLowerCase();
