...
$(document).ready(function () {
	...
	var $questionSet =  [{answer: '6', 
						...
						{answer: '178', 
						 ...
						 {answer: '0,6', 
						 t: 'Верно! Именно 0,6% составляет доля Норникеля в ВВП страны' ,
						 f: 'Математика - это не твоё, да?'},
						 {answer: '10', 
						 t: 'Да, это было легко \nНорильск никогда не спит! Предприятия компании работают в три смены - производство никогда не останавливается. Поэтому в городе в любое время суток есть кто-то, кто собирается на работу, и кто только что с работы пришел.' ,
