...
$(document).ready(function () {
	...
	var $questionSet = [{answer: '180', f: 'Увы, до Тони Старка тебе далеко, попробуй ещё раз'}]
	$("#id").hide();
	...
	$("#checkAnswer").click(function (e) {
		...
		answer = $questionSet[int($("#id").innerHTML)].answer;
		...
		if (client_answer == answer){
			...
			alert($questionSet[int($("#id").innerHTML)].f);
			return;
		}
    });
