...
$(document).ready(function () {
	...
	var $questionSet =  [{answer: '180', 
						 ...
						 f: 'Математика - это не твоё, да?'},
						 {answer: '10', 
						 t: 'Да, это было лекго Норильск никогда не спит! Предприятия компании работают в три смены - производство никогда не останавливается. Поэтому в городе в любое время суток есть кто-то, кто собирается на работу, и кто только что с работы пришел.' ,
						 f: 'Напоминаю, что в сутках всего 24 часа, попробуй ещё раз'},]
	$("#id").hide();
