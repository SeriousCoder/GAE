...
class Question0(webapp2.RequestHandler):
	...
	template_values = {
            'id': "0",
			'someQuestion' : "Привет! <br>Добро пожаловать на небольшой интерактивный квест, в конце которого ты узнаешь 9 интересных фактов о Генеральном партнере форума - компании «Норникель»!<br>Читай внимательно!<br>Полученная информация станет ключевым фактором твоей победы в викторине от компании, которая пройдёт в 17:30 на сцене после мастер-класса!<br>Начнем с простенького: <br>2+2*2=?"}
